        ...
        <div class="container-fluid display-table">
            <div class="row display-table-row">
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="logo">
                        <h1 style="color: white;">Avances Monográficos</h1>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#collapse1">Nuevo Avance Monográfico</a>
                                    </h4>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="Titulo"
                                                                    class="control-label col-sm-2">Titulo</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="fecha"
                                                                    class="control-label col-sm-2">Fecha</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="archivo"
                                                                    class="control-label col-sm-2">Archivo</label>
                                                                <div class="col-sm-10">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="text-center col-sm-10">
                                                                    <div id="LimpiarGroup" class="btn-group"
                                                                        role="group" aria-label="">
                                                                        <button type="button" id="Limpiar"
                                                                            name="Limpiar" class="btn btn-warning"
                                                                            aria-label="limpiar">limpiar</button>
                                                                        <button type="submit" id="Enviar" name="Enviar"
                                                                            class="btn btn-primary"
                                                                            aria-label="limpiar">enviar</button>
                                                                    </div>
                                    ...
                                    <table class="table table-striped table-responsive ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-success">Validado</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
