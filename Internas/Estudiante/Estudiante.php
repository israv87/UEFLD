                ...
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="navi">
                        <ul>
                            ...
                            <li><a href="calificacion.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-xs-12 col-sm-10">
                                            <div class="col-xs-12 col-sm-6">
                                                <ul class="list-group">
                                                    <li class="list-group-item">Jorge Zumba</li>
                                                    <li class="list-group-item">Paralelo: F</li>
                                                    <li class="list-group-item">Profesor: </li>
                                                    <li class="list-group-item"></i> Tema: Registros de Avances monográficos
                                                    </li>
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <ul class="list-group">
                                                    <li class="list-group-item">Informes entregados : 2</li>
                                                    <li class="list-group-item">Observaciones: 2</li>
                                                    <li class="list-group-item">Documentos Validados: 1 </li>
                                                    <li class="list-group-item"></i> Calificaciones: 0
                                                    </li>
                                ...
                                <table class="table table-striped table-responsive ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-warning">Esperando Validación</button> </td>
                                        </tr>
                                        <tr>
                                            <td>Avance Semana 1</td>
                                            <td><img src="../../assets/img/pdf.png"></td>
                                            <td>Faltan referencias </td>
                                            <td><button type="button" class="btn btn-success">Validado</button> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
