        ...
        <div class="container-fluid display-table">
            <div class="row display-table-row">
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="navi">
                        <ul>
                            <li ><a href="docente.php"><i class="fa fa-home" aria-hidden="true"></i><span
                            ...
                            <div class="panel panel-default">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="Titulo" class="control-label ">Nombre del
                                                                    ...
                                                                    <input type="text" class="form-control" id="criterio" placeholder="Criterio">
                                                            </div>
                                                            <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleFormControlSelect1">Parte
                                                                    Monografica</label>
                                                                <select class="form-control" id="parte_monografica">
                                                                    <option>Introduccion</option>
                                                                    <option>Objetivos</option>
                                                                    <option>Marco Teorico</option>
                                                                    <option>Desarrollo</option>
                                                                    <option>Conclusiones</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="Titulo" class="control-label ">Porcentaje</label>
                                                                    ...
                                                                    <input type="text" class="form-control" id="porcentaje" placeholder="%">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label " for="desc">Descripción</label>
                                                                    ...
                                                                    <textarea class="form-control" id="desc" name="desc" rows=2">default text</textarea>
                                ...
                                <div class="bs-callout bs-callout-danger" style="padding-left:1em;">
                                    ...
                                    <table class="table table-striped table-responsive ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Criterio para paralelo A</td>
                                                <td>Introducción</td>
                                                <td>15</td>
                                                <td>Debe ser clara y consisa evitando copiar a otros autores</td>
                                            </tr>
                                            <tr>
                                                <td>Criterio para paralelo A</td>
                                                <td>Objetivos</td>
                                                <td>20</td>
                                                <td>Deben representar todo el proyecto</td>
                                            </tr>
                                            <tr>
                                                <td>Criterio para paralelo A</td>
                                                <td>Marco teorico</td>
                                                <td>30</td>
                                                <td>La información consultada debe ser de utilidad para el desarrollo</td>
                                            </tr>
                                            <tr>
                                                <td>Criterio para paralelo A</td>
                                                <td>Desarrollo</td>
                                                <td>30</td>
                                                <td>Debe estar completo y funcional</td>
                                            </tr>
                                            <tr>
                                                <td>Criterio para paralelo A</td>
                                                <td>Bibliografia</td>
